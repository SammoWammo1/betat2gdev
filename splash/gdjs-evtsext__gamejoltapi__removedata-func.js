...
gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback31823332 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__RemoveData.idToCallbackMap.set(31823332, gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback31823332);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/remove", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback31823332(runtimeScene, eventsFunctionContext, asyncObjectsList)), 31823332, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback31824236 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__RemoveData.idToCallbackMap.set(31824236, gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback31824236);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/remove", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback31824236(runtimeScene, eventsFunctionContext, asyncObjectsList)), 31824236, asyncObjectsList);
}
}
