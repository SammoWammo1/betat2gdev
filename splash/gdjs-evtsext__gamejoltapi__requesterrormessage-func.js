...
gdjs.evtsExt__GamejoltAPI__RequestErrorMessage.idToCallbackMap = new Map();
...
if (isConditionTrue_0) {
{eventsFunctionContext.returnValue = gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().get("__GamejoltAPI").getChild("CompleteStack").getChild(eventsFunctionContext.getArgument("RequestName")).getChild("ErrorMessage"));}
}
