...
gdjs.SplashCode.asyncCallback41847772 = function (runtimeScene, asyncObjectsList) {
...
gdjs.SplashCode.idToCallbackMap.set(41847772, gdjs.SplashCode.asyncCallback41847772);
...
};gdjs.SplashCode.asyncCallback42491204 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.SplashCode.localVariables);
...
gdjs.SplashCode.idToCallbackMap.set(42491204, gdjs.SplashCode.asyncCallback42491204);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(10), (runtimeScene) => (gdjs.SplashCode.asyncCallback42491204(runtimeScene, asyncObjectsList)), 42491204, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(41769740);
}
}
if (isConditionTrue_0) {
