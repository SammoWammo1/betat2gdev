...
gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.idToCallbackMap = new Map();
...
};gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.asyncCallback49692116 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.idToCallbackMap.set(49692116, gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.asyncCallback49692116);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores/add", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.asyncCallback49692116(runtimeScene, eventsFunctionContext, asyncObjectsList)), 49692116, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
{
{gdjs.evtsExt__GamejoltAPI__AddURLParameter.func(runtimeScene, "score", eventsFunctionContext.getArgument("Label"), eventsFunctionContext);
}
