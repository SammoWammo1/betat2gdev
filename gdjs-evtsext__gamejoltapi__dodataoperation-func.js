...
gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback35947564 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__DoDataOperation.idToCallbackMap.set(35947564, gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback35947564);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/update", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback35947564(runtimeScene, eventsFunctionContext, asyncObjectsList)), 35947564, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback35948428 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__DoDataOperation.idToCallbackMap.set(35948428, gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback35948428);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/update", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback35948428(runtimeScene, eventsFunctionContext, asyncObjectsList)), 35948428, asyncObjectsList);
}
}
