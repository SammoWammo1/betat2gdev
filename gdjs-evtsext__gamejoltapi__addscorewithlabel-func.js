...
};gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.asyncCallback31555476 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.idToCallbackMap.set(31555476, gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.asyncCallback31555476);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores/add", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__AddScoreWithLabel.asyncCallback31555476(runtimeScene, eventsFunctionContext, asyncObjectsList)), 31555476, asyncObjectsList);
}
}
