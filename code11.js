...
gdjs.GamejoltCode.asyncCallback32984636 = function (runtimeScene, asyncObjectsList) {
...
gdjs.GamejoltCode.idToCallbackMap.set(32984636, gdjs.GamejoltCode.asyncCallback32984636);
...
};gdjs.GamejoltCode.asyncCallback32200660 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Title", false);
}
gdjs.GamejoltCode.localVariables.length = 0;
}
gdjs.GamejoltCode.idToCallbackMap.set(32200660, gdjs.GamejoltCode.asyncCallback32200660);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.GamejoltCode.asyncCallback32200660(runtimeScene, asyncObjectsList)), 32200660, asyncObjectsList);
}
}
...
};gdjs.GamejoltCode.asyncCallback32203196 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
gdjs.GamejoltCode.localVariables.length = 0;
}
gdjs.GamejoltCode.idToCallbackMap.set(32203196, gdjs.GamejoltCode.asyncCallback32203196);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__AuthenticateUser.func(runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(0).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(1).getAsString(), null), (runtimeScene) => (gdjs.GamejoltCode.asyncCallback32203196(runtimeScene, asyncObjectsList)), 32203196, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(32199884);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(32202220);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.storage.readStringFromJSONFile("gjusername", "gamejolt", runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(0));
