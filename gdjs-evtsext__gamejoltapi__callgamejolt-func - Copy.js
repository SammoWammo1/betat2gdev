...
gdjs.evtsExt__GamejoltAPI__CallGamejolt.idToCallbackMap = new Map();
...
if (isConditionTrue_0) {
{gdjs.evtTools.debuggerTools.log(gdjs.evtsExt__GamejoltAPI__URL.func(runtimeScene, eventsFunctionContext), "", "");
}
}
...
};gdjs.evtsExt__GamejoltAPI__CallGamejolt.userFunc0x13ffb58 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
...
let isConditionTrue_0 = false;
{
{gdjs.evtsExt__GamejoltAPI__PrepareURL.func(runtimeScene, eventsFunctionContext.getArgument("Endpoint"), eventsFunctionContext);
}
{gdjs.evtsExt__GamejoltAPI__SetURL.func(runtimeScene, gdjs.evtsExt__GamejoltAPI__URL.func(runtimeScene, eventsFunctionContext) + ("&signature=" + gdjs.evtsExt__GamejoltAPI__SHA1.func(runtimeScene, gdjs.evtsExt__GamejoltAPI__URL.func(runtimeScene, eventsFunctionContext) + gdjs.evtsExt__GamejoltAPI__GameKey.func(runtimeScene, eventsFunctionContext), eventsFunctionContext) + "#" + gdjs.evtTools.common.toString(gdjs.randomFloat(9999))), eventsFunctionContext);
}
...
gdjs.evtsExt__GamejoltAPI__CallGamejolt.userFunc0x13ffb58(runtimeScene, eventsFunctionContext);
