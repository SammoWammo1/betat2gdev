...
gdjs.evtsExt__GamejoltAPI__SetUsername.idToCallbackMap = new Map();
...
{
{runtimeScene.getGame().getVariables().get("__GamejoltAPI").getChild("Username").setString(eventsFunctionContext.getArgument("Value"));
}
}
