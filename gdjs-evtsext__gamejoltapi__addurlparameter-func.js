...
gdjs.evtsExt__GamejoltAPI__AddURLParameter.idToCallbackMap = new Map();
...
{
{gdjs.evtTools.variable.valuePush(runtimeScene.getGame().getVariables().get("__GamejoltAPI").getChild("Parameters"), eventsFunctionContext.getArgument("Identifier") + "=" + eventsFunctionContext.getArgument("Value"));
}
}
