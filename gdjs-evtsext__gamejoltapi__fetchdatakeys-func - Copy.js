...
gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback49768044 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchDataKeys.idToCallbackMap.set(49768044, gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback49768044);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/get-keys", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback49768044(runtimeScene, eventsFunctionContext, asyncObjectsList)), 49768044, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback49769028 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchDataKeys.idToCallbackMap.set(49769028, gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback49769028);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/get-keys", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchDataKeys.asyncCallback49769028(runtimeScene, eventsFunctionContext, asyncObjectsList)), 49769028, asyncObjectsList);
}
}
