...
gdjs.evtsExt__GamejoltAPI__SetErrorMessage.idToCallbackMap = new Map();
...
{
{runtimeScene.getGame().getVariables().get("__GamejoltAPI").getChild("ErrorMessage").setString(eventsFunctionContext.getArgument("Value"));
}
}
