...
gdjs.GamejoltCode.asyncCallback42608500 = function (runtimeScene, asyncObjectsList) {
...
gdjs.GamejoltCode.idToCallbackMap.set(42608500, gdjs.GamejoltCode.asyncCallback42608500);
...
};gdjs.GamejoltCode.asyncCallback42612660 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
gdjs.GamejoltCode.localVariables.length = 0;
}
gdjs.GamejoltCode.idToCallbackMap.set(42612660, gdjs.GamejoltCode.asyncCallback42612660);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__AuthenticateUser.func(runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(0).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(1).getAsString(), null), (runtimeScene) => (gdjs.GamejoltCode.asyncCallback42612660(runtimeScene, asyncObjectsList)), 42612660, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(42612588);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.storage.readStringFromJSONFile("gjusername", "gamejolt", runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(0));
