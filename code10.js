...
gdjs.GamejoltCode.asyncCallback44115124 = function (runtimeScene, asyncObjectsList) {
...
gdjs.GamejoltCode.idToCallbackMap.set(44115124, gdjs.GamejoltCode.asyncCallback44115124);
...
};gdjs.GamejoltCode.asyncCallback44122828 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
gdjs.GamejoltCode.localVariables.length = 0;
}
gdjs.GamejoltCode.idToCallbackMap.set(44122828, gdjs.GamejoltCode.asyncCallback44122828);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.GamejoltCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__AuthenticateUser.func(runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(0).getAsString(), runtimeScene.getScene().getVariables().getFromIndex(1).getAsString(), null), (runtimeScene) => (gdjs.GamejoltCode.asyncCallback44122828(runtimeScene, asyncObjectsList)), 44122828, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(44121948);
}
}
if (isConditionTrue_0) {
{gdjs.evtTools.storage.readStringFromJSONFile("gjusername", "gamejolt", runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(0));
...
gdjs.GamejoltCode.eventsList2(runtimeScene);
gdjs.GamejoltCode.GDUsernameObjects1.length = 0;
gdjs.GamejoltCode.GDUsernameObjects2.length = 0;
gdjs.GamejoltCode.GDPasswordObjects1.length = 0;
gdjs.GamejoltCode.GDPasswordObjects2.length = 0;
