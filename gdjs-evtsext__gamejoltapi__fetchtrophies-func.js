...
};gdjs.evtsExt__GamejoltAPI__FetchTrophies.asyncCallback36385812 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchTrophies.idToCallbackMap.set(36385812, gdjs.evtsExt__GamejoltAPI__FetchTrophies.asyncCallback36385812);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "trophies", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchTrophies.asyncCallback36385812(runtimeScene, eventsFunctionContext, asyncObjectsList)), 36385812, asyncObjectsList);
}
}
