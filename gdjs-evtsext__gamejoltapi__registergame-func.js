...
gdjs.evtsExt__GamejoltAPI__RegisterGame.idToCallbackMap = new Map();
...
{
{runtimeScene.getGame().getVariables().get("__GamejoltAPI").getChild("GameID").setString(eventsFunctionContext.getArgument("GameIdentifier"));
}
{runtimeScene.getGame().getVariables().get("__GamejoltAPI").getChild("GameKey").setString(eventsFunctionContext.getArgument("GameSecretKey"));
}
