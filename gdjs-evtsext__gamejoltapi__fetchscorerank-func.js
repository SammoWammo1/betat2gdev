...
gdjs.evtsExt__GamejoltAPI__FetchScoreRank.asyncCallback28095492 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreRank.idToCallbackMap.set(28095492, gdjs.evtsExt__GamejoltAPI__FetchScoreRank.asyncCallback28095492);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores/get-rank", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchScoreRank.asyncCallback28095492(runtimeScene, eventsFunctionContext, asyncObjectsList)), 28095492, asyncObjectsList);
}
}
