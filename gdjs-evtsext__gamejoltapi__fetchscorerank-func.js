...
gdjs.evtsExt__GamejoltAPI__FetchScoreRank.asyncCallback28651404 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreRank.idToCallbackMap.set(28651404, gdjs.evtsExt__GamejoltAPI__FetchScoreRank.asyncCallback28651404);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores/get-rank", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchScoreRank.asyncCallback28651404(runtimeScene, eventsFunctionContext, asyncObjectsList)), 28651404, asyncObjectsList);
}
}
