...
};gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30512348 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.idToCallbackMap.set(30512348, gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30512348);
...
};gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30515996 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.idToCallbackMap.set(30515996, gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30515996);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30515996(runtimeScene, eventsFunctionContext, asyncObjectsList)), 30515996, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30518260 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.idToCallbackMap.set(30518260, gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30518260);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchScoreFromUser.asyncCallback30518260(runtimeScene, eventsFunctionContext, asyncObjectsList)), 30518260, asyncObjectsList);
}
}
