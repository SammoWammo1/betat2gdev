...
};gdjs.evtsExt__GamejoltAPI__AddScore.asyncCallback31349620 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__AddScore.idToCallbackMap.set(31349620, gdjs.evtsExt__GamejoltAPI__AddScore.asyncCallback31349620);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores/add", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__AddScore.asyncCallback31349620(runtimeScene, eventsFunctionContext, asyncObjectsList)), 31349620, asyncObjectsList);
}
}
