...
};gdjs.evtsExt__GamejoltAPI__AddScore.asyncCallback31845628 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__AddScore.idToCallbackMap.set(31845628, gdjs.evtsExt__GamejoltAPI__AddScore.asyncCallback31845628);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "scores/add", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__AddScore.asyncCallback31845628(runtimeScene, eventsFunctionContext, asyncObjectsList)), 31845628, asyncObjectsList);
}
}
