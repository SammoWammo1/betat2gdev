...
gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback31835100 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__UpdateSession.idToCallbackMap.set(31835100, gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback31835100);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "sessions/ping", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback31835100(runtimeScene, eventsFunctionContext, asyncObjectsList)), 31835100, asyncObjectsList);
}
}
