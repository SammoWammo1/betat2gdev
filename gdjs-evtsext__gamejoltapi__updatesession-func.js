...
gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback36297092 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__UpdateSession.idToCallbackMap.set(36297092, gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback36297092);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "sessions/ping", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__UpdateSession.asyncCallback36297092(runtimeScene, eventsFunctionContext, asyncObjectsList)), 36297092, asyncObjectsList);
}
}
