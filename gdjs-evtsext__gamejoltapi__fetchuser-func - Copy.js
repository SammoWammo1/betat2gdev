...
gdjs.evtsExt__GamejoltAPI__FetchUser.idToCallbackMap = new Map();
...
{isConditionTrue_0 = eventsFunctionContext.getArgument("WithIdentifier");
}
if (isConditionTrue_0) {
{gdjs.evtsExt__GamejoltAPI__AddURLParameter.func(runtimeScene, "user_id", eventsFunctionContext.getArgument("Username"), eventsFunctionContext);
}
}
...
};gdjs.evtsExt__GamejoltAPI__FetchUser.asyncCallback49642668 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__FetchUser.idToCallbackMap.set(49642668, gdjs.evtsExt__GamejoltAPI__FetchUser.asyncCallback49642668);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "users", eventsFunctionContext.getArgument("RequestName"), eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__FetchUser.asyncCallback49642668(runtimeScene, eventsFunctionContext, asyncObjectsList)), 49642668, asyncObjectsList);
}
}
