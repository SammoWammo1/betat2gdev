...
gdjs.evtsExt__GamejoltAPI__DoDataOperation.idToCallbackMap = new Map();


gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback49749988 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__DoDataOperation.idToCallbackMap.set(49749988, gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback49749988);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/update", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback49749988(runtimeScene, eventsFunctionContext, asyncObjectsList)), 49749988, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback49750852 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__DoDataOperation.idToCallbackMap.set(49750852, gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback49750852);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/update", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__DoDataOperation.asyncCallback49750852(runtimeScene, eventsFunctionContext, asyncObjectsList)), 49750852, asyncObjectsList);
}
}
...
isConditionTrue_0 = false;
{
{isConditionTrue_1 = (("" + eventsFunctionContext.getArgument("Operator")) != "divide");
}
...
{
{isConditionTrue_1 = ((Number(eventsFunctionContext.getArgument("Value")) || 0) != 0);
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
...
{gdjs.evtsExt__GamejoltAPI__AddURLParameter.func(runtimeScene, "operation", eventsFunctionContext.getArgument("Operator"), eventsFunctionContext);
}
{gdjs.evtsExt__GamejoltAPI__AddURLParameter.func(runtimeScene, "value", ("" + eventsFunctionContext.getArgument("Value")), eventsFunctionContext);
}
...
isConditionTrue_1 = false;
{
{isConditionTrue_2 = (("" + eventsFunctionContext.getArgument("Operator")) != "divide");
}
...
{
{isConditionTrue_2 = ((Number(eventsFunctionContext.getArgument("Value")) || 0) != 0);
}
if(isConditionTrue_2) {
    isConditionTrue_1 = true;
}
...
if (isConditionTrue_0) {
{gdjs.evtsExt__GamejoltAPI__SetErrorMessage.func(runtimeScene, "Divide by 0", eventsFunctionContext);
}
{gdjs.evtsExt__GamejoltAPI__SetSuccess.func(runtimeScene, false, eventsFunctionContext);
}
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
