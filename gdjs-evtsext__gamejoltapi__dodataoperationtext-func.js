...
gdjs.evtsExt__GamejoltAPI__DoDataOperationText.asyncCallback38435972 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__DoDataOperationText.idToCallbackMap.set(38435972, gdjs.evtsExt__GamejoltAPI__DoDataOperationText.asyncCallback38435972);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/update", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__DoDataOperationText.asyncCallback38435972(runtimeScene, eventsFunctionContext, asyncObjectsList)), 38435972, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__DoDataOperationText.asyncCallback38436860 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__DoDataOperationText.idToCallbackMap.set(38436860, gdjs.evtsExt__GamejoltAPI__DoDataOperationText.asyncCallback38436860);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/update", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__DoDataOperationText.asyncCallback38436860(runtimeScene, eventsFunctionContext, asyncObjectsList)), 38436860, asyncObjectsList);
}
}
