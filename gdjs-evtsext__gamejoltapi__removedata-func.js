...
gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback38441148 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__RemoveData.idToCallbackMap.set(38441148, gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback38441148);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/remove", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback38441148(runtimeScene, eventsFunctionContext, asyncObjectsList)), 38441148, asyncObjectsList);
}
}
...
};gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback38442052 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction(eventsFunctionContext);
}
eventsFunctionContext.localVariables.length = 0;
}
gdjs.evtsExt__GamejoltAPI__RemoveData.idToCallbackMap.set(38442052, gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback38442052);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(eventsFunctionContext.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "data-store/remove", "", eventsFunctionContext), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__RemoveData.asyncCallback38442052(runtimeScene, eventsFunctionContext, asyncObjectsList)), 38442052, asyncObjectsList);
}
}
